 ...
 */
declare type ComponentTemplate<T> = <U extends T>(rf: ɵRenderFlags, ctx: T | U) => void;
 ...
 * logs.
 */
declare type DefinitionFactory<D extends Definition<any>> = (logger: NodeLogger) => D;
...
declare type DisposableFn = () => void;
...
declare type ElementHandleEventFn = (view: ViewData, eventName: string, event: any) => boolean;
...
declare type ViewHandleEventFn = (view: ViewData, nodeIndex: number, eventName: string, event: any) => boolean;
...
declare type ViewUpdateFn = (check: NodeCheckFn, view: ViewData) => void;
...
export declare function ɵand(
    flags: ɵNodeFlags,
    matchedQueriesDsl: null | [string | number, ɵQueryValueType][],
    ngContentIndex: null | number, childCount: number,
...
export declare function ɵangular_packages_core_core_bc(
    checkIndex: number, flags: ɵNodeFlags, matchedQueriesDsl:
    [string | number, ɵQueryValueType][] | null, childCount: number, token: any, value: any, deps:
    ([ɵDepFlags, any] | any)[], bindings?: BindingDef[], outputs?: OutputDef[]): NodeDef;
 ...
 */
export declare function ɵangular_packages_core_core_bl(
    lView: ɵangular_packages_core_core_ca, bindingRoot: number, slotOffset: number, pureFn: (v: any) => any, exp: any, thisArg?: any): any;
 ...
 * @returns Updated or cached value
 */
export declare function ɵangular_packages_core_core_bm(
    lView: ɵangular_packages_core_core_ca, bindingRoot:
    number, slotOffset: number, pureFn: (v1: any, v2: any) => any, exp1: any, exp2: any, thisArg?: any): any;
 ...
 * @returns Updated or cached value
 */
export declare function ɵangular_packages_core_core_bn(
    lView: ɵangular_packages_core_core_ca, bindingRoot: number, slotOffset: number, pureFn:
    (v1: any, v2: any, v3: any) => any, exp1: any, exp2: any, exp3: any, thisArg?: any): any;
